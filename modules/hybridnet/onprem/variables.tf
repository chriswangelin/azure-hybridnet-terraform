variable onprem_name {
  type        = string
  description = "Name of the (simulated) on-premises data center. Used as a name prefix for resources in this module."
  default     = "onprem"
}

variable resource_group_name {
  type        = string
  description = "Resource group name. Set to <onprem_name>-rg if not specified."
  default     = null
}
...
variable vnet_name {
  type        = string
  description = "Virtual network name. Set to <onprem_name>-vnet if not specified."
  default     = null
}
...
variable winra_snet_name {
  type        = string
  description = "Windows Remote Access Services (RAS) subnet name. Set to <onprem_name>-winra-snet if not specified."
  default     = null
}
...
variable winra_snet_nsg_name {
  type        = string
  description = "Windows Remote Access Services (RAS) subnet network security group name. Set to <onprem_name>-winra-snet-nsg if not specified."
  default     = null
}
...
variable dns_snet_name {
  type        = string
  description = "DNS subnet name. Set to <onprem_name>-dns-snet if not specified."
  default     = null
}
...
variable dns_snet_nsg_name {
  type        = string
  description = "DNS subnet network security group name. Set to <onprem_name>-dns-snet-nsg if not specified."
  default     = null
}
...
variable mgmt_snet_name {
  type        = string
  description = "Management subnet name. Set to <onprem_name>-mgmt-snet if not specified."
  default     = null
}
...
variable mgmt_snet_nsg_name {
  type        = string
  description = "Management subnet Network security group name. Set to <onprem_name>-mgmt-snet-nsg if not specified."
  default     = null
}
...
variable mgmt_vm_name {
  type        = string
  description = "Name of management virtual machine name. Set to <onprem_name>-mgmt-vm if not specified."
...
variable winra_vm_name {
  type        = string
  description = "Name of the Windows Remote Access Services virtual machine. Set to <onprem_name>-winra-vm if not specified."
  default     = null
}
...
variable dns_vm_001_name {
  type        = string
  description = "Name of the Windows Remote Access Services virtual machine. Set to <onprem_name>-dns-vm-001 if not specified."
  default     = null
}
...
variable route_table_name {
  type        = string
  description = "Route table name. Set to <onprem_name>-to-hub if not specified."
  default     = null
}
...
variable local_gateway_name {
  type        = string
  description = "Local gateway name. Set to <onprem_name>-lgw if not specified."
  default     = null
}
