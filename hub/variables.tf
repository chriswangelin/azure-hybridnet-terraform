...
variable afw_enable {
  type        = bool
  description = "Enable Azure firewall if true"
  default     = false
}
...
variable peering_enable {
  type        = bool
  description = "If true, Create peering between on-prem and hub network and vice-versa"
  default     = false
}

variable onprem_vnet_resource_group_name {
  type        = string
  description = "Resource group containing on-prem simulator vnet"
  default     = null
}

variable onprem_vnet_name {
  type        = string
  description = "On-prem simulator vnet name"
  default     = null
}

variable onprem_vnet_id {
  type        = string
  description = "On-prem simulator vnet ID"
  default     = null
}
